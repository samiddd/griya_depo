    ...
    <div class="wrapper">
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="white">
                ...
                <a href="#" class="logo">
                    <img src="{{ asset('assets/') }}../../admin-assets/assets/img/griyadepo.png"
                        style="max-width: 60%;" alt="navbar brand" class="navbar-brand">
            ...
            <nav class="navbar navbar-header navbar-expand-lg" data-background-color="orange">
                ...
                document.getElementById('logout-form').submit();"
                    class="btn btn-warning ml-auto"><i class="fa fa-sign-out"></i> Logout</a>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('adminMitra.index') }}">
                                <i class="fas fa-users-cog"></i>
                                <p>Mitra</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('adminKontraktor.index') }}">
                                <i class="
                                fas fa-users"></i>
                                <p>Kontraktor</p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('adminPerbaikan.index') }}">
                                <i class="fas fa-wrench"></i>
                                <p>Perbaikan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('adminPembangunan.index') }}">
                                <i class="
                                fas fa-home"></i>
                                <p>Pembangunan</p>
                            </a>
