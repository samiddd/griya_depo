...
@section('body')
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('adminMitra.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                {{ csrf_field() }}
                <div class="card">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        placeholder="Masukkan Nama Mitra" value="" required>
                                    @error('nama')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username"
                                        placeholder="Masukkan Kode Mitra" value="" required>
                                    @error('username')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
